...
# montana_synmontana <- 
#   # data
#   medicaid_expansion_full %>%   
#   # filter just Kansas 
#   filter(state == "Montana") %>% 
#   # bind columns 
#   bind_cols(difference = syn_sum$att$Estimate) %>%    # add in estimate 
#   # calculate synthetic Kansas
#   mutate(synthetic_montana = lngdpcapita + difference) # adds the estimate to the observed Kansas to create synthetic Kansas
# 
...
```
Fix this code to include synthetic montana based on the example notebook on kansas that did the manual calculations
