...
#Treatment
#People are prescribed blood pressure medication based on the following risk factors/measures a physician would look at:
...
#I guess I'm thinking of this latter mediator as sort of the social factors that a doctor dosn't really look for in examination, while the treatment is related to the risk factors I think a physician would look at. 
...
So this is messy! And this is the simplified version! I guess my interpretation is kind of that there are sub-DAGs and then DAGs. As previously mentioned, I could get even more nitpicky and make a relationship between income and college education, etc. but I wanted to focus on the most meaningful relationships. Let's chart one more DAG that is a little more straightforward
...
# Label the nodes 
  labels = c(
    "A" = "Blood\n Pressure\n Meds",        # Treatment 
    "Y" = "Mortality",        # Outcome (mortality)
    "W" = "Physician\n Risk\n Assessment",        # Things physicians would look at as risk factors (as described above)
    "X" = "Social"         # How observed covariates impact these risk factors in ways physicians wouldn't see (as described above)
  ),
